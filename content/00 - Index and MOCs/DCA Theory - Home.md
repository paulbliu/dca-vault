...
A structured reference for decline curve theory, methods, and equations.
...
## 🧠 Mental Model: The Full Timeline


                   Classical Era             Modern Era
                  (Pre-shale)               (Shale Boom)
                   __________________________________________
                                           
 1945 --- 1980 --------- 1988 ------ | --- 2008 ---- 2010 ------ 2011
   |       |               |         |       |         |          |
  Arps   Fetkovich      Robertson   ----    PLE       SEPD      Duong
        Type Curves     (bridge)            Ilk-      Valko-    (2010)
                                           Rushing     Lee   

- **Pre-1988**: Classical/diagnostic methods
- **Post-2008**: Modern unconventional methods
- **Robertson (1988)**: The bridge — sits mathematically with classical, gets used with modern
## OxyGPT / Workflow
- [[OxyGPT Tool Cheat Sheet]]
- [[Case Study Workflow - OxyGPT DCA]]
- [[Case Study Index]]

## Workflow / Decision / Assumptions
- [[DCA Method Selection Guide]]
